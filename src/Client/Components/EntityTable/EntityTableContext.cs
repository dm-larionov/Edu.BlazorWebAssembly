...
namespace Edu.BlazorWebAssembly.Client.Components.EntityTable;
...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
    ...
    /// <summary>
    /// The EduResource that is representing this entity. This is used in combination with the xxActions to check for permissions.
    /// </summary>
    public string? EntityResource { get; }

    /// <summary>
    /// The EduAction name of the search permission. This is EduAction.Search by default.
    ...
    /// <summary>
    /// The permission name of the create permission. This is EduAction.Create by default.
    ...
    /// <summary>
    /// The permission name of the update permission. This is EduAction.Update by default.
    ...
    /// <summary>
    /// The permission name of the delete permission. This is EduAction.Delete by default.
    ...
    /// <summary>
    /// The permission name of the export permission. This is EduAction.Export by default.
    /// </summary>
        ...
        Func<TEntity, bool>? canDeleteEntityFunc)
    {
        ...
        SearchAction = searchAction ?? EduAction.Search;
        CreateAction = createAction ?? EduAction.Create;
        UpdateAction = updateAction ?? EduAction.Update;
        DeleteAction = deleteAction ?? EduAction.Delete;
        ExportAction = exportAction ?? EduAction.Export;
