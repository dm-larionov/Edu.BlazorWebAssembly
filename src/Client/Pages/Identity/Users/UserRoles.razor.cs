...
public partial class UserRoles
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canEditUsers = await AuthService.HasPermissionAsync(state.User, EduAction.Update, EduResource.Users);
        _canSearchRoles = await AuthService.HasPermissionAsync(state.User, EduAction.View, EduResource.UserRoles);
