...
namespace Edu.BlazorWebAssembly.Client.Pages.Identity.Users;
...
public partial class Users
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canExportUsers = await AuthService.HasPermissionAsync(user, EduAction.Export, EduResource.Users);
        _canViewRoles = await AuthService.HasPermissionAsync(user, EduAction.View, EduResource.UserRoles);

        Context = new(
            entityName: L["User"],
            entityNamePlural: L["Users"],
            entityResource: EduResource.Users,
