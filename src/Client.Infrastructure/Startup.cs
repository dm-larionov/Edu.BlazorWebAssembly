...
namespace Edu.BlazorWebAssembly.Client.Infrastructure;
...
public static class Startup
{
    ...
    {
        foreach (var permission in EduPermissions.All)
        {
            options.AddPolicy(permission.Name, policy => policy.RequireClaim(EduClaims.Permission, permission.Name));
        }
    }
